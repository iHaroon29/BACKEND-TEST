...
module.exports = {
  async getAllCourseSectionsOfCourse(req, res) {
    try {
      const allCourseSections =
        await CourseSectionService.getAllCourseSectionByCourseId(
          req.params.courseId
        );
  ...
  async addNewCourseSection(req, res) {
    try {
      const addedCourseSection = await CourseSectionService.addNewCourseSection(
        req.params.courseId,
        req.body
      );
  ...
  async deleteCourseSection(req, res) {
    try {
      const deletedCourse = await CourseSectionService.getCourseSectionDetails(
        req.params.courseSectionId
      );
  ...
  async getCourseSectionDetails(req, res) {
    try {
      const courseSectionDetails =
        await CourseSectionService.getCourseSectionDetails(
          req.params.courseSectionId
        );
  ...
  async getAllCourseSections(req, res) {
    try {
